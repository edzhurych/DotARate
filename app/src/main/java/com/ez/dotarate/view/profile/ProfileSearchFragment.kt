                ...
                when (position) {
                    0 -> {
                        tab.icon = ContextCompat.getDrawable(
                            requireContext(),
                            R.drawable.vp_games_icon_selector
                        )
                    }
                    1 -> {
                        tab.icon = ContextCompat.getDrawable(
                            requireContext(),
                            R.drawable.vp_mph_icon_selector
                        )
                    }
                }
            }).attach()
